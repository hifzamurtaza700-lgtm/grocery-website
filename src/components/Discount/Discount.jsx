...
<span className=' text-orange-500 md:text-8xl text-5xl font-bold  transform md:-rotate-90 h-fit md:self-center'>20%</span>
<div className=' max-w-[700px] '>
    <h3 className='md:text-5xl text-4xl font-bold '>First Order Discount </h3>
